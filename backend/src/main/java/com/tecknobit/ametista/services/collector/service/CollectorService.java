...
/**
 * The {@code CollectorService} class is useful to collect all the issues and analytics data sent by the Ametista Engine
 *
 ...
 */
@Service
public class CollectorService extends ApplicationsService {
    ...
    /**
     * Method to collect a {@link PerformanceAnalyticType#LAUNCH_TIME} analytic
     *
     * @param applicationId The identifier of the application
     * @param appVersion The application version
     * @param platform The platform to connect
    ...
    /**
     * Method to calculate the {@link PerformanceAnalyticType#ISSUES_PER_SESSION} rate and save it
     *
     * @param applicationId The identifier of the application
     * @param appVersion The application version
     * @param platform The platform to connect
